            ...
            <form class="flex max-h-[85vh] flex-col" @submit.prevent="submit">
                ...
                >
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-0.5 text-xs text-slate-500">
                            Datos, identificación y vehículo
                        </p>
                    </div>
                    <button
                        type="button"
                ...
                <div class="flex-1 space-y-7 overflow-y-auto px-6 py-6">
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            <Lucide icon="User" class="h-3.5 w-3.5" /> Datos
                            personales
                        </div>
                        <div
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                >
                                    ...
                                    <button
                                        type="button"
                                        class="absolute -top-2 -right-2 hidden h-5 w-5 items-center justify-center rounded-full bg-danger text-white group-hover:flex"
                                        @click="removeExisting('vehicle', m)"
                                    >
                                        <Lucide icon="X" class="h-3 w-3" />
                                    </button>
                                </div>
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        multiple
                                        class="hidden"
                                        @change="stageFiles($event, 'vehicle')"
                                    />
                                </label>
                            </div>
                        </div>
                            ...
                            >
                                <FormCheck>
                                    <FormCheck.Input
                                        ...
                                        type="checkbox"
                                    />
                                    <FormCheck.Label htmlFor="g-marketing"
                                        >Acepta marketing</FormCheck.Label
                                    >
                                </FormCheck>
                            </div>
                            <div
