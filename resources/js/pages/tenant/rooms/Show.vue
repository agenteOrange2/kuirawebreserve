        ...
        <div class="grid grid-cols-12 gap-x-6 gap-y-8">
            ...
            <div class="col-span-12 flex flex-col xl:col-span-8">
                ...
                <div class="box box--stacked mt-3.5 flex flex-1 flex-col p-5">
                    ...
                    >
                        <div
                            class="flex items-center justify-between border-b border-dashed border-slate-200/70 pb-3 dark:border-darkmode-400"
                        >
                    ...
                    <div
                        class="mt-4 flex flex-wrap gap-x-6 gap-y-2 border-t border-dashed border-slate-300/70 pt-4 text-sm dark:border-darkmode-400"
                    >
                        <span
                            ...
                            "
                        >
                            <Lucide icon="Cigarette" class="h-4 w-4" />
                            {{ room.smoking ? 'Se permite fumar' : 'No fumar' }}
                        </span>
                        <span
                            class="flex items-center gap-1.5"
                            :class="
                            ...
                            "
                        >
                            <Lucide icon="Accessibility" class="h-4 w-4" />
                    ...
                    <div
                        ...
                        "
                        class="mt-4 space-y-2 border-t border-dashed border-slate-300/70 pt-4 text-sm dark:border-darkmode-400"
                    >
                        ...
                        <p v-if="room.maintenance_notes" class="text-pending">
                            <Lucide
                                icon="Wrench"
            ...
            <div class="col-span-12 flex flex-col xl:col-span-4">
                ...
                <div class="box box--stacked mt-3.5 flex flex-1 flex-col p-5">
                    <div class="space-y-3 text-sm">
                        ...
                        <div class="flex items-center justify-between">
                            <span class="flex items-center gap-2 text-slate-500"
                                ><Lucide icon="Clock" class="h-4 w-4" /> Última
                                estancia</span
                            >
