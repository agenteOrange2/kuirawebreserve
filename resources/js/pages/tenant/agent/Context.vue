            ...
            <div class="mt-5 grid grid-cols-12 gap-5">
                ...
                <div class="col-span-12 xl:col-span-7">
                    <div class="box box--stacked flex h-full flex-col p-5">
                        ...
                        />
                        <FormHelp
                            >Vacío = sin instrucciones adicionales del
                            hotel.</FormHelp
                        >
                        <div
                    ...
                    <div class="box box--stacked flex h-full flex-col p-5">
                        ...
                        >
                            <div class="min-w-0">
                                ...
                                <p class="mt-1 text-sm text-slate-500">
                                    Así ve el mundo tu asistente: identidad,
                                    datos del hotel, tarifas, FAQs, tus
                                    instrucciones y las reglas — armado en vivo.
                                </p>
                            </div>
                            <Button
                                variant="outline-secondary"
