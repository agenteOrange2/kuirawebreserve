...
<template>
    <RazeLayout title="Cortes de venta">
        <div class="grid grid-cols-12 gap-x-6 gap-y-8">
                ...
                <div class="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <Button
                            ...
                            :disabled="preview.grand_total <= 0"
            ...
            <div class="col-span-12 flex flex-col xl:col-span-6">
                <div class="flex items-center md:h-10">
                    <div class="text-base font-medium">Desglose por origen</div>
                </div>
                <div class="box box--stacked mt-3.5 flex-1 p-5">
                    <div class="space-y-3">
                        <div
                    ...
                    >
                        <Lucide icon="Info" class="h-4 w-4 shrink-0" /> El corte
                        cuenta lo que
                        <span class="font-medium">{{
                            selectedUser?.name
                        }}</span>
                        cobró en el periodo. Al guardarlo, el siguiente corte
                        arranca desde aquí.
                    </p>
                </div>
            </div>
                    ...
                    <div class="flex items-start gap-3.5">
                        ...
                        <div>
                            <h2 class="text-base font-medium">
                                Cerrar corte de {{ selectedUser?.name }}
                            </h2>
