        ...
        <div class="mt-3.5 grid grid-cols-12 gap-5">
            ...
            <div class="col-span-12 sm:col-span-6 xl:col-span-3">
                <div class="box box--stacked h-full p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <div class="text-2xl font-medium">
                                {{ fmt(stats.ai_replies_month) }}
                            </div>
                            <div class="mt-0.5 text-xs text-slate-500">
                                Respuestas IA · {{ monthLabel }}
                            </div>
                        </div>
                    </div>
                    <div
            ...
            <div class="col-span-12 sm:col-span-6 xl:col-span-3">
                <div class="box box--stacked h-full p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <div class="text-2xl font-medium">
                                {{ fmt(stats.ai_tokens_month) }}
                            </div>
                            <div class="mt-0.5 text-xs text-slate-500">
                                Tokens IA · {{ monthLabel }}
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="ml-4">
                            <div class="text-2xl font-medium">
                                {{ stats.ai_keys_active
                                    ...
                                    >/{{ stats.ai_keys_total }}</span
                                >
                            </div>
                            <div class="mt-0.5 text-xs text-slate-500">
                                Keys maestras activas
                            </div>
                        </div>
                    </div>
                    <div
            ...
            <div class="col-span-12 xl:col-span-8">
                <div class="box box--stacked flex h-full flex-col">
                    <div
                        class="flex items-center justify-between border-b border-dashed border-slate-300/70 px-5 py-4"
                    >
                        <h2 class="text-base font-medium">
                            Actividad del bot · últimos 14 días
                        </h2>
                        <span
                            class="rounded-full bg-info/10 px-2.5 py-0.5 text-xs text-info"
                        >
                    ...
                    <div class="flex flex-1 flex-col justify-end p-5">
                        <div class="flex h-40 items-end gap-1.5">
                            ...
                            >
                                <div
                                    class="mb-1 text-[10px] text-slate-500 opacity-0 transition group-hover:opacity-100"
                                >
                                    {{ day.replies }}
                                </div>
                                <div
                                    ...
                                    :class="
                                        day.replies
                                            ...
                                            : 'bg-slate-200/70 dark:bg-darkmode-400'
                                    "
                                    :style="{
                                        height: day.replies
                                            ? `${Math.max(6, (day.replies / maxActivity) * 100)}%`
                                            : '4px',
                                    }"
                                />
                            </div>
                        ...
                        <div
                            class="mt-2 flex gap-1.5 border-t border-dashed border-slate-300/70 pt-2"
                        >
                            <div
                                v-for="day in activity"
                                :key="day.date"
                        ...
                        <div v-for="plan in planDistribution" :key="plan.value">
                            ...
                            >
                                <span class="flex items-center gap-2">
                                    ...
                                    >
                                        <Lucide icon="Bot" class="h-3 w-3" /> IA
                                        incluida
                                    </span>
                                </span>
                            ...
                            >
                                <div
                                    ...
                                    :style="{
                                        width: `${Math.max(plan.count ? 6 : 0, (plan.count / maxPlanCount) * 100)}%`,
                                    }"
                                />
                            </div>
                        </div>
                        <div
                            class="border-t border-dashed border-slate-300/70 pt-3 text-xs text-slate-500"
                        >
                            {{ stats.users }} usuario(s) con acceso al panel de
                            plataforma.
                        </div>
                    </div>
                </div>
            ...
            <div class="col-span-12">
                <div class="box box--stacked">
                    ...
                    >
                        <h2 class="text-base font-medium">
                            Uso de IA por hotel · {{ monthLabel }}
                        </h2>
                        <Link
                            :href="route('admin.ai')"
                    ...
                    <div class="overflow-auto p-5 lg:overflow-visible">
                            ...
                            <Table.Thead>
                                <Table.Tr>
                                    ...
                                    <Table.Th class="text-right"
                                        >Tokens (entrada / salida)</Table.Th
                                    >
                                </Table.Tr>
                            </Table.Thead>
                            <Table.Tbody>
                                ...
                                >
                                    ...
                                    <Table.Td>
                                        <template v-if="row.limit">
                                            ...
                                            >
                                                <div
                                                    class="h-2 w-32 rounded-full bg-slate-200/70 dark:bg-darkmode-400"
                                                >
                                                    <div
                        ...
                        <div v-else class="py-8 text-center text-slate-500">
                            Ningún hotel tiene IA en su plan todavía. Los planes
                            con IA aparecerán aquí con su consumo.
                        </div>
                    </div>
                </div>
            </div>
