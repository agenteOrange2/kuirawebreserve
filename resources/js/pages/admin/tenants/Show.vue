...
const payLocal = reactive<Record<string, boolean>>(
    Object.fromEntries(
        props.paymentMethods.map((m) => [m.method, m.tenant_enabled]),
    ),
);
...
const userForm = reactive({
    ...
    email: '',
    password: '',
    role: props.ops.assignable_roles[0] ?? 'front-desk',
});
            ...
            <div class="flex min-w-0 items-center gap-3.5">
                ...
                <div class="min-w-0">
                    <div class="flex items-center gap-2">
                        <h1
                            class="truncate text-lg font-medium group-[.mode--light]:text-white"
                        >
                            {{ tenant.name }}
                        </h1>
                        <span
        ...
        <div class="mt-3.5 grid grid-cols-12 gap-5">
            ...
            <div class="col-span-6 sm:col-span-4 xl:col-span-2">
                <div class="box box--stacked h-full p-4">
                    <div class="flex items-center gap-3">
                        <div
                            class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-info/10 bg-info/10"
                        >
                            <Lucide
                                icon="BedDouble"
            ...
            <div class="col-span-6 sm:col-span-4 xl:col-span-2">
                <div class="box box--stacked h-full p-4">
                    <div class="flex items-center gap-3">
                        <div
                            class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-success/10 bg-success/10"
                        >
                            <Lucide
                                icon="CalendarCheck"
            ...
            <div class="col-span-6 sm:col-span-4 xl:col-span-2">
                <div class="box box--stacked h-full p-4">
                    <div class="flex items-center gap-3">
                        <div
                            class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-warning/10 bg-warning/10"
                        >
                            <Lucide
                                icon="Banknote"
            ...
            <div class="col-span-6 sm:col-span-4 xl:col-span-2">
                <div class="box box--stacked h-full p-4">
                    <div class="flex items-center gap-3">
                        <div
                            class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-pending/10 bg-pending/10"
                        >
                            <Lucide
                                icon="DoorOpen"
            ...
            <div class="col-span-6 sm:col-span-4 xl:col-span-2">
                <div class="box box--stacked h-full p-4">
                    <div class="flex items-center gap-3">
                        <div
                            class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-dark/10 bg-dark/10"
                        >
                            <Lucide
                                icon="MessagesSquare"
                                class="h-5 w-5 text-dark dark:text-slate-300"
                            />
                        </div>
                        <div class="min-w-0">
                            <div class="text-lg font-medium">
            ...
            <div class="col-span-12 xl:col-span-4">
                <div class="box box--stacked flex h-full flex-col">
                    ...
                    <div class="flex flex-1 flex-col gap-3 p-5 text-sm">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="font-medium"
                                >{{ ops.properties
                                    ...
                                    /
                                    {{
                                        plan.max_properties ?? 'sin límite'
                                    }}</span
                                ></span
                            >
                        </div>
                        ...
                        <div
                            class="mt-auto border-t border-dashed border-slate-300/70 pt-3 text-xs text-slate-500"
                        >
                            {{ ops.guests }} huésped(es) en su CRM ·
                            {{ ops.conversations_pending }} conversación(es)
                            esperando humano
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-1 flex-col gap-3 p-5 text-sm">
                        <template v-if="plan.ai_enabled">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                >
                                <span class="font-medium">{{
                                    ai.tokens.toLocaleString('es-MX')
                                }}</span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-slate-500"
                                    >BYOK (keys propias)</span
                                >
                                <span
                                    class="text-xs"
                                    :class="
                        ...
                        <div
                            v-else
                            class="flex flex-1 flex-col items-center justify-center gap-2 py-4 text-center"
                        >
                            <Lucide
                                icon="BotOff"
                            ...
                            <p class="text-xs text-slate-500">
                                Su plan no incluye IA — palanca de upsell.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-1 flex-col gap-3.5 p-5 text-sm">
                        ...
                        >
                            ...
                            <FormSwitch
                                ...
                                :title="
                                    !m.platform_enabled
                                        ? 'Método apagado globalmente en Pagos; el toggle del hotel no aplica hasta reencenderlo'
                                        : undefined
                                "
                            >
                                <FormSwitch.Input
                        ...
                        <FormHelp class="mt-auto">
                            Control de la plataforma: lo que apagues aquí no se
                            ofrece a los huéspedes de este hotel ni aparece en
                            su panel.
                        </FormHelp>
                    </div>
                </div>
                                ...
                                >
                                    ...
                                    >
                                        <Lucide
                                            ...
                                            class="h-3 w-3"
                                        />
                                        El hotel solicitó activarlo el
                                        {{ mod.requested_at }}
                                    </span>
                                    <button
                                        type="button"
            ...
            <div class="col-span-12 xl:col-span-4">
                <div class="box box--stacked flex h-full flex-col">
                    ...
                    >
                        ...
                        >
                            {{ users.length
                            }}<template v-if="plan.max_users">
                                / {{ plan.max_users }}</template
                            >
                        </span>
                        <Button
                    ...
                    <div
                        class="max-h-72 flex-1 divide-y divide-dashed divide-slate-300/70 overflow-y-auto px-5 py-2"
                    >
                        <div
                            v-for="u in users"
                            :key="u.id"
                        ...
                        >
                            <div
                                class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-linear-to-br from-theme-1 to-theme-2 text-[10px] font-semibold text-white"
                            >
                                {{ initialsOf(u.name) }}
                            </div>
                            <div class="min-w-0 flex-1">
                            ...
                            <div class="flex shrink-0 items-center gap-1">
                                <button
                                    type="button"
                                    title="Editar acceso"
                                    class="flex h-7 w-7 items-center justify-center rounded-full text-slate-400 transition hover:bg-primary/10 hover:text-primary"
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <FormSelect id="user-role" v-model="userForm.role">
                                <option
                                    v-for="r in ops.assignable_roles"
                                    :key="r"
                                    :value="r"
                                >
                                    {{ roleLabel(r) }}
                            ...
                            <FormHelp
                                v-if="userErrors.role"
                                class="text-danger"
                                >{{ userErrors.role }}</FormHelp
                            >
                        </div>
                        <p
                            v-if="userErrors._"
